# URL Params and Search Params (Senior Frontend Engineer Perspective)

Before going deeper into frameworks or libraries, understand this topic as part of real frontend engineering: using the URL as shareable application state.
...
* URL Params and Search Params matters because it affects real users, future maintainers, and production behavior.
...
Create a React component that demonstrates URL Params and Search Params.
...
For senior-level work, URL Params and Search Params is not only a syntax topic. You should be able to explain the mental model, choose the right pattern for a product requirement, identify common failure modes, and verify behavior through tooling, tests, and browser inspection.
