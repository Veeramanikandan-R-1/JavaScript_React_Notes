...
### 1. How would you explain Capstone: React Dashboard in a real project?
...
### 2. What happens internally when Capstone: React Dashboard is involved?

A reviewer should be able to run it, understand the architecture, see non-happy-path states, and inspect clean code.

### 3. How do you debug issues related to Capstone: React Dashboard?
...
### 4. What is the biggest production risk with Capstone: React Dashboard?
