# Web Vitals, LCP, CLS, and INP (Senior Frontend Engineer Perspective)

Before going deeper into frameworks or libraries, understand this topic as part of real frontend engineering: measuring user-centered performance.
...
* Web Vitals, LCP, CLS, and INP matters because it affects real users, future maintainers, and production behavior.
...
Measure a page or component related to Web Vitals, LCP, CLS, and INP.
