...
### 1. How would you explain Rendering Performance, Layout, and Paint in a real project?

Performance work starts with measurement: Web Vitals, DevTools traces, bundle analysis, React Profiler, and real-user metrics.

### 2. What happens internally when Rendering Performance, Layout, and Paint is involved?
...
### 3. How do you debug issues related to Rendering Performance, Layout, and Paint?

I optimize the biggest measured issue first and protect it with a budget, test, or monitoring signal.

### 4. What is the biggest production risk with Rendering Performance, Layout, and Paint?
...
1. Explain Rendering Performance, Layout, and Paint in two minutes.
