...
### 1. How would you explain React Performance and Profiling in a real project?

Performance work starts with measurement: Web Vitals, DevTools traces, bundle analysis, React Profiler, and real-user metrics.

### 2. What happens internally when React Performance and Profiling is involved?
...
### 3. How do you debug issues related to React Performance and Profiling?

I optimize the biggest measured issue first and protect it with a budget, test, or monitoring signal.

### 4. What is the biggest production risk with React Performance and Profiling?
...
1. Explain React Performance and Profiling in two minutes.
